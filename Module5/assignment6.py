...
def Plot2DBoundary(DTrain, LTrain, DTest, LTest):
    # The dots are training samples (img not drawn), and the pics are testing
    # samples (images drawn)
    ...
    # Don't get too detailed; smaller values (finer rez) will take longer to compute
    resolution = 1
    ...
    for index in LTest.index:
        ...
        ax.imshow(img, aspect='auto', cmap=plt.cm.gray,
                  interpolation='nearest', zorder=100000,
    ...
    for label in range(len(np.unique(LTrain))):
        ...
        ax.scatter(DTrain[indices, 0], DTrain[indices, 1], c=colors[label],
                   alpha=0.8, marker='o')
...
# their underlying indices later on. This is necessary so you can find your
# samples in the original dataframe, which you will use to plot your testing
