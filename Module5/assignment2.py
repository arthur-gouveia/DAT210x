...
#
# TODO: Further filter it down for calls that are came in either before 6AM OR
# after 10pm (22:00:00).
# You can use < and > to compare the string times, just make sure you code them
# as military time strings, eg: "06:00:00", "22:00:00":
